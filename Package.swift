...
let package = Package(
    ...
    dependencies: [
      ...
      .package(url: "https://github.com/IBM-Swift/SwiftKueryMySQL", .upToNextMinor(from: "1.0.0")),
    ...
    targets: [
      ...
      .target(name: "Application", dependencies: [ "Kitura", "Configuration", "CloudEnvironment","SwiftMetrics","Health", "SwiftKueryORM", "SwiftKueryMySQL"]),
